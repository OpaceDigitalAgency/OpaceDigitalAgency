...
| **[Add as Preferred Source Button & Popup for Google (SEO & AI Overviews): Site Checker - Chrome extension](https://github.com/OpaceDigitalAgency/preferred-source-checker-for-google-chrome-extension)** | Toolbar audit of any site's Google Preferred Sources setup: eligibility shape, SDK install check, deeplink add and embed code. 100% local. |
