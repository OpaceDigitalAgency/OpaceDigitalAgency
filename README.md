...
| **[Add as Preferred Source — WordPress Plugin](https://github.com/OpaceDigitalAgency/add-as-preferred-source-button-for-google-wordpress-plugin)** | Google's official Preferred Sources popup button for WordPress with smart placement, CRO triggers and honest click analytics, for SEO visibility in AI Overviews, Discover and Top Stories. |
...
| Project                                                                                  | What it provides                                                                                                                                                                                                             |
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Preferred Source Checker — Chrome Extension](https://github.com/OpaceDigitalAgency/preferred-source-checker-for-google-chrome-extension)** | Toolbar audit of any site's Google Preferred Sources setup: eligibility shape, SDK install check, deeplink add and embed code. 100% local. |
